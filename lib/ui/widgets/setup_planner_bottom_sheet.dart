...
import 'package:better_breaks/ui/widgets/setup_summary_bottom_sheet.dart';
import 'package:better_breaks/shared/widgets/shared_widgets.dart';

class SetupPlannerBottomSheet extends StatefulWidget {
  ...
  @override
  State<SetupPlannerBottomSheet> createState() =>
      _SetupPlannerBottomSheetState();
}

class _SetupPlannerBottomSheetState extends State<SetupPlannerBottomSheet>
  ...
  void _onAccept() {
    showModalBottomSheet(
      ...
      builder: (context) => SetupSummaryBottomSheet(
